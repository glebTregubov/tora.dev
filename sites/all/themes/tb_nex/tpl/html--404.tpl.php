...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php print $language->language; ?>" lang="<?php print $language->language; ?>" dir="<?php print $language->dir; ?>">
  ...
  <body class="body-404"<?php print $attributes; ?>>
    ...
    <?php print $page_top; ?>
		...
		<h1>Oops...! 404</h1>
		<p>
			The page you are looking for cannot be found. Please check the URL. Otherwise, you can use the homepage link below and navigate through the TB Nex site from there.
		</p>
		<a href="<?php print base_path() ?>">Home page</a>
		</div>
  </body>
</html>